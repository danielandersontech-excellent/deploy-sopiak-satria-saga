/**
 * ============================================================
 * PUSH NOTIFICATION MANAGER v2 - Fully Connected
 * ============================================================
 * UPGRADE:
 ...
 *   // di dalam MainTabs atau MainNavigation:
 *   usePushNotificationManager(navigation);
 */
...
// ===== MAIN HOOK =====
export function usePushNotificationManager(navigation: any) {
  ...
  useEffect(() => {
    if (!isLoggedIn || !navigation) return;
