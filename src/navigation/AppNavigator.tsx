...
const splashStyles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#1a5276', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 40 },
  logo: { width: 180, height: 180, marginBottom: 24 },
  title: { fontSize: 22, fontWeight: '800', color: '#ffffff', letterSpacing: 1.2, textAlign: 'center' },
